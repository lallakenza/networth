...
import { fmt, fmtAxis } from './render.js?v=237';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=237';
import { IMMO_CONSTANTS, EQUITY_HISTORY } from './data.js?v=237';
