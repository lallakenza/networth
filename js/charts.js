...
import { fmt, fmtAxis } from './render.js?v=75';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=75';
import { IMMO_CONSTANTS, NW_HISTORY } from './data.js?v=75';
