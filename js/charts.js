...
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=340';
import { IMMO_CONSTANTS, EQUITY_HISTORY, PORTFOLIO, FX_STATIC, DESIGN_TOKENS } from './data.js?v=340';
