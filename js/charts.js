...
import { fmt, fmtAxis } from './render.js?v=238';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=238';
import { IMMO_CONSTANTS, EQUITY_HISTORY } from './data.js?v=238';
