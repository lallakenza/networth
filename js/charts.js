...
import { fmt, fmtAxis } from './render.js?v=315';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=315';
import { IMMO_CONSTANTS, EQUITY_HISTORY, PORTFOLIO, FX_STATIC } from './data.js?v=315';
