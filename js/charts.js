...
import { fmt, fmtAxis } from './render.js?v=316';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=316';
import { IMMO_CONSTANTS, EQUITY_HISTORY, PORTFOLIO, FX_STATIC } from './data.js?v=316';
