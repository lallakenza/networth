...
import { fmt, fmtAxis } from './render.js?v=326';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=326';
import { IMMO_CONSTANTS, EQUITY_HISTORY, PORTFOLIO, FX_STATIC, DESIGN_TOKENS } from './data.js?v=326';
