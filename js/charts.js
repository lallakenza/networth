...
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=477';
import { IMMO_CONSTANTS, EQUITY_HISTORY, PORTFOLIO, FX_STATIC, DESIGN_TOKENS } from './data.js?v=477';
import { PRICE_SNAPSHOT } from './price_snapshot.js?v=477';
import { loadSnapshots } from './api.js?v=477'; // v387 — historique NW (snapshots quotidiens Supabase)
import { CASH_ACCOUNT_IDS } from './engine.js?v=477'; // v388 — labels FR de l'explorateur de séries
