...
import { fmt, fmtAxis } from './render.js?v=293';
import { getGrandTotal, computeExitCostsAtYear } from './engine.js?v=293';
import { IMMO_CONSTANTS, EQUITY_HISTORY, PORTFOLIO, FX_STATIC } from './data.js?v=293';
