...
import { PORTFOLIO, FX_STATIC } from './data.js?v=31';
import { compute } from './engine.js?v=31';
import { render } from './render.js?v=31';
import { fetchFXRates, fetchStockPrices } from './api.js?v=31';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=31';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=31';
