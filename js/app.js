...
import { PORTFOLIO, FX_STATIC } from './data.js?v=87';
import { compute } from './engine.js?v=87';
import { render } from './render.js?v=87';
import { fetchFXRates, fetchStockPrices } from './api.js?v=87';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=87';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=87';
