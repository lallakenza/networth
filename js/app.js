...
import { PORTFOLIO, FX_STATIC } from './data.js?v=85';
import { compute } from './engine.js?v=85';
import { render } from './render.js?v=85';
import { fetchFXRates, fetchStockPrices } from './api.js?v=85';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=85';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=85';
