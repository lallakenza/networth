...
import { PORTFOLIO, FX_STATIC, DATA_LAST_UPDATE, EQUITY_HISTORY, APP_VERSION , PRICE_REFS_AS_OF } from './data.js?v=542';
import { deverrouiller, deverrouillerDepuisSession, blobDisponible,
         deverrouillerDepuisAppareil, deverrouillerDepuisServeur,
         appareilAppaire, oublierAppareil } from './unlock.js?v=542';
import { compute, getGrandTotal, buildDailySnapshot } from './engine.js?v=542';
import { render, applySnapshotDeltas } from './render.js?v=542';
import { chargerContratDistant } from './facturation_contract.js?v=542';
import { fetchFXRates, fetchStockPrices, retryFailedTickers, fetchSoldStockPrices, clearCache, fetchHistoricalPrices, getStockQuote, getStockHistory, resolveMarket, getMoroccanPriceAt, pickMoroccanPriceAt, getHistoricalBase, saveHistStore, saveServerHistory, maybeSaveDailySnapshot, loadSnapshots, loadImmoRef, applyImmoRef } from './api.js?v=542';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut, buildPortfolioYTDChart, redrawChartForPeriod, switchChartMode, buildEquityHistoryChart, renderPortfolioChart } from './charts.js?v=542';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=542';
...
window.nwEnvoyerCode = async (email) => {
  const auth = await import('./auth.js?v=542');
