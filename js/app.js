...
import { PORTFOLIO, FX_STATIC } from './data.js?v=47';
import { compute } from './engine.js?v=47';
import { render } from './render.js?v=47';
import { fetchFXRates, fetchStockPrices } from './api.js?v=47';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=47';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=47';
