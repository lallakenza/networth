...
import { PORTFOLIO, FX_STATIC } from './data.js?v=86';
import { compute } from './engine.js?v=86';
import { render } from './render.js?v=86';
import { fetchFXRates, fetchStockPrices } from './api.js?v=86';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=86';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=86';
