...
import { PORTFOLIO, FX_STATIC } from './data.js?v=42';
import { compute } from './engine.js?v=42';
import { render } from './render.js?v=42';
import { fetchFXRates, fetchStockPrices } from './api.js?v=42';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=42';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=42';
