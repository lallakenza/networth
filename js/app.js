...
import { PORTFOLIO, FX_STATIC, DATA_LAST_UPDATE } from './data.js?v=118';
import { compute } from './engine.js?v=118';
import { render } from './render.js?v=118';
import { fetchFXRates, fetchStockPrices, retryFailedTickers } from './api.js?v=118';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=118';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=118';
