...
import { PORTFOLIO, FX_STATIC } from './data.js?v=52';
import { compute } from './engine.js?v=52';
import { render } from './render.js?v=52';
import { fetchFXRates, fetchStockPrices } from './api.js?v=52';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=52';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=52';
