...
import { PORTFOLIO, FX_STATIC } from './data.js?v=78';
import { compute } from './engine.js?v=78';
import { render } from './render.js?v=78';
import { fetchFXRates, fetchStockPrices } from './api.js?v=78';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=78';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=78';
