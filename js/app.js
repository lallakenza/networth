...
import { PORTFOLIO, FX_STATIC } from './data.js?v=77';
import { compute } from './engine.js?v=77';
import { render } from './render.js?v=77';
import { fetchFXRates, fetchStockPrices } from './api.js?v=77';
import { rebuildAllCharts, buildCFProjection, coupleChartZoomOut } from './charts.js?v=77';
import { initSimulators, bindSimulatorEvents } from './simulators.js?v=77';
