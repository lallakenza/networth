    ...
    villejuif: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '5 -3 308 266',
          rooms: [
            { name: 'Salle de bain', surface: 5.45, color: '#94a3b8', points: '140,0 192,0 192,40 140,40' },
            { name: 'Entrée', surface: 3.6, color: '#94a3b8', points: '192,0 228,0 228,40 192,40' },
            { name: 'WC', surface: 2.32, color: '#94a3b8', points: '228,0 260,0 260,28 228,28' },
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3b82f6', points: '65,0 140,0 140,40 260,40 252,130 45,130' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '45,133 252,133 260,160 38,160' },
            { name: 'Chambre 2', surface: 11.24, color: '#22c55e', points: '38,163 128,163 108,260 8,260' },
            { name: 'Chambre 1', surface: 11.24, color: '#22c55e', points: '185,163 260,163 310,260 185,260' },
          ],
        },
      },
    },
