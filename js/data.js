  ...
  properties: {
    vitry: {
      ...
      details: {
        ...
        exposure: 'Sud-Ouest',
        floorPlan: {
          image: 'img/plan_vitry.png',
          width: 1900,
          height: 1800,
          rooms: [
            { name: 'Loggia', surface: 8.1, color: '#d69e2e', points: '3,3 3,27 20,27 20,17 37,17 37,3' },
            { name: 'Cuisine', surface: 8.52, color: '#3182ce', points: '37,3 37,17 57,17 57,3' },
            { name: 'Entrée', surface: 5.85, color: '#a0aec0', points: '57,3 57,17 72,17 72,3' },
            { name: 'Séjour', surface: 21.28, color: '#3182ce', points: '3,27 3,62 55,62 55,37 72,37 72,17 57,17 37,17 20,17 20,27' },
            { name: 'WC', surface: 1.6, color: '#a0aec0', points: '60,17 60,29 72,29 72,17' },
            { name: 'Salle de bain', surface: 4.44, color: '#a0aec0', points: '55,29 55,51 72,51 72,29' },
            { name: 'Dégagement', surface: 2.2, color: '#a0aec0', points: '42,51 42,62 55,62 55,51' },
            { name: 'Chambre 1', surface: 12.34, color: '#48bb78', points: '3,62 3,95 42,95 42,62' },
            { name: 'Chambre 2', surface: 9.14, color: '#48bb78', points: '55,51 55,95 88,95 88,51 72,51' },
          ],
        },
      },
    },
    ...
    villejuif: {
      ...
      details: {
        ...
        exposure: 'Sud-Ouest',
        floorPlan: {
          image: 'img/plan_villejuif.png',
          width: 1800,
          height: 1700,
          rooms: [
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3182ce', points: '15,8 15,55 75,55 75,8 50,8 50,3 30,3 30,8' },
            { name: 'Chambre 2', surface: 11.24, color: '#48bb78', points: '3,20 3,70 28,70 28,55 15,55 15,20' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '15,55 15,72 75,72 75,55' },
            { name: 'Chambre 1', surface: 11.24, color: '#48bb78', points: '62,55 62,90 92,90 92,55 75,55' },
            { name: 'Entrée', surface: 3.60, color: '#a0aec0', points: '50,3 50,15 65,15 65,3' },
            { name: 'Salle de bain', surface: 5.45, color: '#a0aec0', points: '65,3 65,25 80,25 80,3' },
            { name: 'WC', surface: 2.32, color: '#a0aec0', points: '80,3 80,25 92,25 92,3' },
          ],
        },
      },
    },
