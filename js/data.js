    ...
    vitry: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '-38 -3 92 96',
          rooms: [
            { name: 'Loggia', surface: 8.1, color: '#d69e2e', points: '-35,0 0,0 0,23 -35,23' },
            { name: 'Cuisine', surface: 8.52, color: '#3b82f6', points: '0,0 28,0 28,30 0,30' },
            { name: 'Entrée', surface: 5.85, color: '#94a3b8', points: '28,0 46,0 46,33 28,33' },
            { name: 'Séjour', surface: 21.28, color: '#3b82f6', points: '-35,23 0,23 0,30 28,30 28,60 -35,60' },
            { name: 'WC', surface: 2.09, color: '#94a3b8', points: '28,33 44,33 44,46 28,46' },
            { name: 'Salle de bain', surface: 4.87, color: '#94a3b8', points: '28,46 50,46 50,68 28,68' },
            { name: 'Dgt', surface: 2.2, color: '#94a3b8', points: '4,60 18,60 18,76 4,76' },
            { name: 'Chambre 1', surface: 12.38, color: '#22c55e', points: '-35,60 4,60 4,92 -35,92' },
            { name: 'Chambre 2', surface: 9.95, color: '#22c55e', points: '18,60 50,60 50,90 18,90' },
          ],
        },
      },
    },
    ...
    villejuif: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '-2 7 332 293',
          rooms: [
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3b82f6', points: '52,17 160,17 160,60 270,60 270,152 62,152' },
            { name: 'Salle de bain', surface: 5.45, color: '#94a3b8', points: '160,17 208,17 208,60 160,60' },
            { name: 'Entrée', surface: 3.6, color: '#94a3b8', points: '208,17 245,17 245,60 208,60' },
            { name: 'WC', surface: 2.32, color: '#94a3b8', points: '245,17 290,17 290,48 245,48' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '60,155 272,155 278,187 54,187' },
            { name: 'Chambre 2', surface: 11.24, color: '#22c55e', points: '34,187 110,187 110,290 8,290' },
            { name: 'Chambre 1', surface: 11.24, color: '#22c55e', points: '210,187 278,187 320,290 210,290' },
          ],
        },
      },
    },
