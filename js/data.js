  ...
  properties: {
    vitry: {
      ...
      details: {
        ...
        exposure: 'Sud-Ouest',
        floorPlan: {
          viewBox: '-380 -30 912 978',
          rooms: [
            { name: 'Loggia', surface: 8.1, color: '#d69e2e', points: '-350,0 0,0 0,231 -350,231' },
            { name: 'Cuisine', surface: 8.52, color: '#3b82f6', points: '0,0 280,0 280,304 0,304' },
            { name: 'Entrée', surface: 5.85, color: '#94a3b8', points: '280,0 459,0 459,327 280,327' },
            { name: 'Séjour', surface: 21.28, color: '#3b82f6', points: '-350,231 0,231 0,304 280,304 280,601 -350,601' },
            { name: 'WC', surface: 2.09, color: '#94a3b8', points: '280,327 440,327 440,458 280,458' },
            { name: 'Salle de bain', surface: 4.87, color: '#94a3b8', points: '280,458 502,458 502,678 280,678' },
            { name: 'Dgt', surface: 2.2, color: '#94a3b8', points: '40,601 175,601 175,764 40,764' },
            { name: 'Chambre 1', surface: 12.38, color: '#22c55e', points: '-350,601 40,601 40,918 -350,918' },
            { name: 'Chambre 2', surface: 9.95, color: '#22c55e', points: '175,601 502,601 502,905 175,905' },
          ],
        },
      },
    },
    rueil: {
      ...
      details: {
        ...
        floorPlan: {
          schematic: true,
          viewBox: '-20 -20 940 660',
          rooms: [
            { name: 'Cuisine', surface: null, color: '#3b82f6', points: '0,0 260,0 260,280 0,280' },
            { name: 'Entrée', surface: null, color: '#94a3b8', points: '260,0 520,0 520,280 260,280' },
            { name: 'Salon', surface: null, color: '#3b82f6', points: '520,0 900,0 900,280 520,280' },
            { name: 'Chambre 2', surface: null, color: '#22c55e', points: '0,280 300,280 300,620 0,620' },
            { name: 'Dégagement', surface: null, color: '#94a3b8', points: '300,280 570,280 570,420 300,420' },
            { name: 'Salle de bain', surface: null, color: '#94a3b8', points: '300,420 450,420 450,620 300,620' },
            { name: 'WC', surface: null, color: '#94a3b8', points: '450,420 570,420 570,620 450,620' },
            { name: 'Chambre 1', surface: null, color: '#22c55e', points: '570,280 900,280 900,620 570,620' },
          ],
        },
      },
    },
    villejuif: {
      ...
      details: {
        ...
        exposure: 'Sud-Ouest',
        floorPlan: {
          viewBox: '-166 -30 1212 1028',
          rooms: [
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3b82f6', points: '0,0 274,0 274,211 951,211 951,507 -71,507' },
            { name: 'Salle de bain', surface: 5.45, color: '#94a3b8', points: '274,0 532,0 532,211 274,211' },
            { name: 'Entrée', surface: 3.6, color: '#94a3b8', points: '532,0 703,0 703,211 532,211' },
            { name: 'WC', surface: 2.32, color: '#94a3b8', points: '703,0 880,0 880,131 703,131' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '-71,507 951,507 964,599 -84,599' },
            { name: 'Chambre 2', surface: 11.24, color: '#22c55e', points: '-84,599 248,599 201,935 -131,935' },
            { name: 'Chambre 1', surface: 11.24, color: '#22c55e', points: '662,599 964,599 1016,968 714,968' },
          ],
        },
      },
    },
