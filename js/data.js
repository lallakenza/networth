  ...
  properties: {
    vitry: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '-3 -3 91 100',
          rooms: [
            { name: 'Loggia', surface: 8.1, color: '#d69e2e', points: '0,0 35,0 35,23 0,23' },
            { name: 'Cuisine', surface: 8.52, color: '#3b82f6', points: '35,0 63,0 63,30 35,30' },
            { name: 'Entrée', surface: 5.85, color: '#94a3b8', points: '63,0 81,0 81,33 63,33' },
            { name: 'Séjour', surface: 21.28, color: '#3b82f6', points: '0,23 35,23 35,30 63,30 63,60 0,60' },
            { name: 'WC', surface: 2.09, color: '#94a3b8', points: '63,33 79,33 79,46 63,46' },
            { name: 'Salle de bain', surface: 4.87, color: '#94a3b8', points: '63,46 85,46 85,68 63,68' },
            { name: 'Dgt', surface: 2.2, color: '#94a3b8', points: '36,60 49,60 49,77 36,77' },
            { name: 'Chambre 1', surface: 12.38, color: '#22c55e', points: '0,60 36,60 36,94 0,94' },
            { name: 'Chambre 2', surface: 9.95, color: '#22c55e', points: '49,60 85,60 85,87 49,87' },
          ],
        },
      },
    },
    rueil: {
      ...
      details: {
        ...
        floorPlan: {
          ...
          viewBox: '-3 -3 94 82',
          rooms: [
            { name: 'Cuisine', surface: 6.11, color: '#3b82f6', points: '0,8 23,8 23,36 0,36' },
            { name: 'Entrée', surface: 4.39, color: '#94a3b8', points: '23,7 39,7 39,36 23,36' },
            { name: 'Salon', surface: 16.62, color: '#3b82f6', points: '39,0 88,0 88,36 39,36' },
            { name: 'Chambre 2', surface: 9.6, color: '#22c55e', points: '0,38 28,38 28,74 0,74' },
            { name: 'Dégagement', surface: 3.25, color: '#94a3b8', points: '28,38 58,38 58,50 28,50' },
            { name: 'Salle de bain', surface: 3.21, color: '#94a3b8', points: '28,50 44,50 44,72 28,72' },
            { name: 'WC', surface: 0.99, color: '#94a3b8', points: '44,50 54,50 54,60 44,60' },
            { name: 'Chambre 1', surface: 11.49, color: '#22c55e', points: '58,36 88,36 88,76 58,76' },
          ],
        },
      },
    },
    villejuif: {
      ...
      details: {
        ...
        exposure: 'Sud-Ouest',
        floorPlan: {
          // Solved by constraint-based geometric solver (18° V-angle, <5% area error)
          viewBox: '-111 -5 472 337',
          rooms: [
            { name: 'Salle de bain', surface: 5.45, color: '#94a3b8', points: '51,0 138,0 138,70 51,70' },
            { name: 'Entrée', surface: 3.6, color: '#94a3b8', points: '138,0 195,0 195,70 138,70' },
            { name: 'WC', surface: 2.32, color: '#94a3b8', points: '195,0 250,0 250,47 195,47' },
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3b82f6', points: '0,0 51,0 51,70 273,70 309,182 -59,182' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '-59,182 309,182 318,210 -68,210' },
            { name: 'Chambre 2', surface: 11.24, color: '#22c55e', points: '-68,210 38,210 0,327 -106,327' },
            { name: 'Chambre 1', surface: 11.24, color: '#22c55e', points: '211,210 318,210 356,327 249,327' },
          ],
        },
      },
    },
