    ...
    vitry: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '0 0 300 250',
          rooms: [
            { name: 'Loggia', x: 0, y: 0, w: 80, h: 65, color: '#d69e2e' },
            { name: 'Cuisine', x: 80, y: 0, w: 75, h: 65, color: '#3182ce' },
            { name: 'Entrée', x: 155, y: 0, w: 55, h: 65, color: '#a0aec0' },
            { name: 'Séjour', x: 0, y: 65, w: 130, h: 90, color: '#3182ce' },
            { name: 'WC', x: 130, y: 65, w: 40, h: 35, color: '#a0aec0' },
            { name: 'Sdb', x: 130, y: 100, w: 80, h: 55, color: '#a0aec0' },
            { name: 'Dgt', x: 95, y: 155, w: 35, h: 95, color: '#a0aec0' },
            { name: 'Chambre 1', x: 0, y: 155, w: 95, h: 95, color: '#48bb78' },
            { name: 'Chambre 2', x: 130, y: 155, w: 80, h: 95, color: '#48bb78' },
          ],
        },
      },
    },
    ...
    villejuif: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '0 0 350 200',
          rooms: [
            { name: 'Chambre 2', x: 0, y: 0, w: 80, h: 100, color: '#48bb78' },
            { name: 'Loggia', x: 80, y: 30, w: 90, h: 70, color: '#d69e2e' },
            { name: 'Séjour/Cuisine', x: 80, y: 0, w: 180, h: 100, color: '#3182ce' },
            { name: 'Entrée', x: 200, y: 0, w: 50, h: 40, color: '#a0aec0' },
            { name: 'Salle de bain', x: 250, y: 0, w: 50, h: 50, color: '#a0aec0' },
            { name: 'WC', x: 250, y: 50, w: 50, h: 30, color: '#a0aec0' },
            { name: 'Chambre 1', x: 200, y: 100, w: 100, h: 100, color: '#48bb78' },
          ],
        },
      },
    },
