  ...
  properties: {
    vitry: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '0 0 100 94',
          rooms: [
            { name: 'Loggia', surface: 8.1, color: '#d69e2e', points: '2,2 2,28 18,28 18,18 40,18 40,2' },
            { name: 'Cuisine', surface: 8.52, color: '#3b82f6', points: '40,2 40,32 64,32 64,2' },
            { name: 'Entrée', surface: 5.85, color: '#94a3b8', points: '64,2 64,32 78,32 78,2' },
            { name: 'Séjour', surface: 21.28, color: '#3b82f6', points: '3,28 3,63 57,63 57,38 78,38 78,32 64,32 40,32 18,32 18,28' },
            { name: 'WC', surface: 2.09, color: '#94a3b8', points: '60,32 60,42 78,42 78,32' },
            { name: 'Salle de bain', surface: 4.87, color: '#94a3b8', points: '57,42 57,63 78,63 78,42' },
            { name: 'Dégagement', surface: 2.20, color: '#94a3b8', points: '38,63 38,76 57,76 57,63' },
            { name: 'Chambre 1', surface: 12.38, color: '#22c55e', points: '3,63 3,92 38,92 38,63' },
            { name: 'Chambre 2', surface: 9.95, color: '#22c55e', points: '57,63 57,92 92,92 92,63' },
          ],
        },
      },
    },
    rueil: {
      ...
      details: {
        ...
        floorPlan: {
          ...
          viewBox: '0 0 100 75',
          rooms: [
            { name: 'Salon', surface: null, color: '#3b82f6', points: '2,2 2,38 48,38 48,2' },
            { name: 'Cuisine', surface: null, color: '#3b82f6', points: '50,2 50,22 72,22 72,2' },
            { name: 'Entrée', surface: null, color: '#94a3b8', points: '50,24 50,38 72,38 72,24' },
            { name: 'Salle de bain', surface: null, color: '#94a3b8', points: '74,2 74,22 98,22 98,2' },
            { name: 'WC', surface: null, color: '#94a3b8', points: '74,24 74,38 98,38 98,24' },
            { name: 'Chambre 1', surface: null, color: '#22c55e', points: '2,40 2,73 35,73 35,40' },
            { name: 'Chambre 2', surface: null, color: '#22c55e', points: '37,40 37,73 68,73 68,40' },
          ],
        },
      },
    },
    villejuif: {
      ...
      details: {
        ...
        exposure: 'Sud-Ouest',
        floorPlan: {
          viewBox: '-110 0 920 510',
          rooms: [
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3b82f6', points: '170,30 530,30 657,250 43,250' },
            { name: 'Entrée', surface: 3.60, color: '#94a3b8', points: '410,30 460,30 460,70 410,70' },
            { name: 'Salle de bain', surface: 5.45, color: '#94a3b8', points: '460,30 510,30 510,80 460,80' },
            { name: 'WC', surface: 2.32, color: '#94a3b8', points: '460,80 510,80 510,120 460,120' },
            { name: 'Chambre 2', surface: 11.24, color: '#22c55e', points: '43,250 -84,470 52,470 179,250' },
            { name: 'Chambre 1', surface: 11.24, color: '#22c55e', points: '537,250 664,470 784,470 657,250' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '179,250 52,470 664,470 537,250' },
          ],
        },
      },
    },
