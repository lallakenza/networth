    ...
    vitry: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '0 0 100 92',
          rooms: [
            { name: 'Loggia', surface: 8.1, color: '#d69e2e', points: '2,2 2,30 15,30 15,20 40,20 40,2' },
            ...
            { name: 'Séjour', surface: 21.28, color: '#3b82f6', points: '2,30 2,64 58,64 58,38 78,38 78,32 64,32 40,32 15,32 15,30' },
            { name: 'WC', surface: 2.09, color: '#94a3b8', points: '64,32 64,42 78,42 78,32' },
            { name: 'Salle de bain', surface: 4.87, color: '#94a3b8', points: '58,42 58,64 78,64 78,42' },
            { name: 'Dégagement', surface: 2.20, color: '#94a3b8', points: '38,64 38,78 58,78 58,64' },
            { name: 'Chambre 1', surface: 12.38, color: '#22c55e', points: '2,64 2,92 38,92 38,64' },
            { name: 'Chambre 2', surface: 9.95, color: '#22c55e', points: '58,64 58,92 90,92 90,64' },
          ],
        },
      },
    },
    ...
    villejuif: {
      ...
      details: {
        ...
        floorPlan: {
          viewBox: '0 0 140 100',
          rooms: [
            { name: 'Entrée', surface: 3.60, color: '#94a3b8', points: '55,2 55,15 72,15 72,2' },
            { name: 'Salle de bain', surface: 5.45, color: '#94a3b8', points: '72,2 72,22 90,22 90,2' },
            { name: 'WC', surface: 2.32, color: '#94a3b8', points: '90,2 90,22 102,22 102,2' },
            { name: 'Séjour/Cuisine', surface: 35.09, color: '#3b82f6', points: '15,8 15,55 85,55 85,22 72,22 72,15 55,15 55,2 38,2 38,8' },
            { name: 'Chambre 2', surface: 11.24, color: '#22c55e', points: '2,22 2,68 30,68 30,55 15,55 15,22' },
            { name: 'Loggia', surface: 9.51, color: '#d69e2e', points: '15,55 15,72 85,72 85,55' },
            { name: 'Chambre 1', surface: 11.24, color: '#22c55e', points: '85,55 85,95 120,95 120,55' },
          ],
        },
      },
    },
