...
// './data.js' et './data.js?v=508' sont DEUX modules distincts, donc deux objets PORTFOLIO
...
import * as DATA from './data.js?v=508';
...
export async function blobDisponible() {
  ...
  try { DATA_ENC = (await import('./data.enc.js?v=508')).DATA_ENC; return !!DATA_ENC; }
