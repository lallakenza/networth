...
// './data.js' et './data.js?v=549' sont DEUX modules distincts, donc deux objets PORTFOLIO
...
import * as DATA from './data.js?v=549';
...
export async function blobDisponible() {
  ...
  try {
    DATA_ENC = (await import('./data.enc.js?v=549')).DATA_ENC;
