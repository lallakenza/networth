...
// './data.js' et './data.js?v=511' sont DEUX modules distincts, donc deux objets PORTFOLIO
...
import * as DATA from './data.js?v=511';
...
export async function blobDisponible() {
  ...
  try { DATA_ENC = (await import('./data.enc.js?v=511')).DATA_ENC; return !!DATA_ENC; }
